...
RUBRICAS: list[tuple[tuple[str, ...], str, str]] = [
    ...
    # DSR e estouro com conta própria no resumo (Diário Jorge 31/01)
    (("horas dsr", "dsr diurn", "dsr", "descanso semanal"), "provento", "dsr"),
    (("estouro do mes", "estouro do mês"), "provento", "estouro"),
    ...
    (("desconto adiantamento", "adiantamento salarial", "adiantamento",
      "desconto de adiantemaneto", "desconto de adiantamento"),
     "desconto", "adiantamento"),
    (("falta",), "desconto", "falta"),
    (("desconto de vales", "desconto vales", "vales - sem"), "desconto", "vales"),
